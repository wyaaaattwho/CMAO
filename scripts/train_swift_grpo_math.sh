...
export CMAO_LAMBDA_QUAL=${CMAO_LAMBDA_QUAL:-0.0}
export CMAO_LAMBDA_MODE=${CMAO_LAMBDA_MODE:-0.0}
export CMAO_QUALITY_SIGNAL=${CMAO_QUALITY_SIGNAL:-raw}
export CMAO_QUALITY_MARGIN=${CMAO_QUALITY_MARGIN:-0.05}
export CMAO_CONCISE_TOKEN_CAP=${CMAO_CONCISE_TOKEN_CAP:-512}

EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen35_9b_math500_swift_grpo_$(date +%Y%m%d_%H%M)}
